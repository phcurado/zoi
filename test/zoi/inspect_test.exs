  ...
  test "inspect all types" do
    types = [
      ...
      {Zoi.object(%{name: Zoi.string(), age: Zoi.integer()}),
       "#Zoi.object<coerce: false, strict: false, fields: %{name: #Zoi.string<required: true, coerce: false>, age: #Zoi.integer<required: true, coerce: false>}>"},
      ...
      {Zoi.struct(MyStruct, %{name: Zoi.string(), age: Zoi.integer()}),
       "#Zoi.struct<coerce: false, strict: false, fields: %{name: #Zoi.string<required: true, coerce: false>, age: #Zoi.integer<required: true, coerce: false>}, module: MyStruct>"},
