defmodule Zoi.Types.NaiveDateTime do
  ...
  defimpl Zoi.Type do
    def parse(schema, %NaiveDateTime{} = input, opts) do
  ...
  defimpl Zoi.Validations.Gte do
    def validate(schema, input, opts) do
      ...
      case NaiveDateTime.compare(input, min) do
        :gt -> :ok
        :eq -> :ok
  ...
  defimpl Zoi.Validations.Lte do
    def validate(schema, input, opts) do
      ...
      case NaiveDateTime.compare(input, max) do
        :lt -> :ok
        :eq -> :ok
  ...
  defimpl Zoi.Validations.Gt do
    def validate(schema, input, opts) do
      ...
      case NaiveDateTime.compare(input, gt) do
        :gt -> :ok
  ...
  defimpl Zoi.Validations.Lt do
    def validate(schema, input, opts) do
      ...
      case NaiveDateTime.compare(input, lt) do
        :lt -> :ok
