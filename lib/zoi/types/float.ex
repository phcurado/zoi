  ...
  defimpl Zoi.Validations.Gte do
    ...
    def validate(_schema, input, value, opts) do
      if input >= value do
        ...
        {:error, Zoi.Error.greater_than_or_equal_to(:float, value, opts)}
      end
    end
  end
  ...
  defimpl Zoi.Validations.Lte do
    ...
    def validate(_schema, input, value, opts) do
      if input <= value do
        ...
        {:error, Zoi.Error.less_than_or_equal_to(:float, value, opts)}
      end
    end
  end
  ...
  defimpl Zoi.Validations.Gt do
    ...
    def validate(_schema, input, value, opts) do
      if input > value do
        ...
        {:error, Zoi.Error.greater_than(:float, value, opts)}
      end
    end
  end
  ...
  defimpl Zoi.Validations.Lt do
    ...
    def validate(_schema, input, value, opts) do
      if input < value do
        ...
        {:error, Zoi.Error.less_than(:float, value, opts)}
      end
    end
  end
